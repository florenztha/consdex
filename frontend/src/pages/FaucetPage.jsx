...
function FaucetPage() {
  ...
  // Hanya ambil zodiac tokens dari constants
  const zodiacTokens = ZODIAC_TOKENS.map((z, index) => ({
    ...z,
    address: `0x${(index + 100).toString(16).padStart(40, '0')}`, // placeholder address
    decimals: 18,
  }))
